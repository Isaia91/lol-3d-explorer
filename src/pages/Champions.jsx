...
export default function Champions() {
    ...
    useEffect(() => {
        (async () => {
            try {
                // 1) Tous les champions (Data Dragon)
                const { version, champions } = await getChampions("fr_FR");
                setVersion(version);
                setChampions(champions);

                // 2) Rotation gratuite (Riot API)
    ...
    // map id numérique -> objet champion
            ...
            <section className="container pb-4">
                ...
                {freeChamps.length > 0 ? (
                    ...
                    >
                        ...
                        <button className="carousel-control-prev" type="button" data-bs-target="#freeRotation" data-bs-slide="prev">
                            <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span className="visually-hidden">Précédent</span>
                        </button>
                        <button className="carousel-control-next" type="button" data-bs-target="#freeRotation" data-bs-slide="next">
